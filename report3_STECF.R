...
effort_CS$country <- effort_CS$country.name
effort_CS$total.kW.days.at.Sea <- effort_CS$Total.kW.days.at.sea
df <- effort_CS
df <- effort_CS %>% filter(country %in% c("Scotland", "Belgium","Germany",         
                                   "England and Wales (UK)", "Spain","France",     
...
#Plot
plot_stecf(df,type = "effort", variable= "COUNTRY", "2021","October", 9, "21-10", return_data = FALSE)
...
#data
dat <- plot_stecf(effort_CS,type = "effort", variable= "COUNTRY", "2019","August", 9, "15-23", return_data = TRUE)
...
#Plot
plot_stecf(effort_CS,type = "effort", variable= "GEAR", "2019","August", 9, "15-23")
ggplot2::ggsave(paste0(cap_year, "_", ecoreg,"_FO_STECF_effortGear.png"), path = "report/", width = 178, height = 130, units = "mm", dpi = 300)

#data
dat<-plot_stecf(effort_CS,type = "effort", variable= "GEAR", "2019","August", 9, "15-23", return_data = TRUE)
...
#Plot
plot_stecf(landings_CS,type = "landings", variable= "GEAR", "2019","August", 9, "15-23")
ggplot2::ggsave(paste0(cap_year, "_", ecoreg,"_FO_STECF_landings.png"), path = "report/", width = 178, height = 130, units = "mm", dpi = 300)
#dat
dat <- plot_stecf(landings_CS, type = "landings", variable="landings", "2019","August", 9, "15-23", return_data = TRUE)
write.taf(dat, file= paste0(cap_year, "_", ecoreg,"_FO_STECF_landings.csv"), dir = "report")
